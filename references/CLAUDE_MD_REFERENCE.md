...
Before starting work, read `docs/product/PRODUCT_PILOT.md`. It tells you what phase
...
For deep context: see the files in `docs/product/` (Pilot, vision, features, roadmap,
...
Before starting work, read docs/product/PRODUCT_PILOT.md for product context.
After finishing work, follow the session-end checklist in the Pilot to update product docs.
Commit doc changes alongside code changes.

See docs/product/ for: vision, features, roadmap, metrics, research, competitive landscape.
```
...
Before starting work, review `docs/product/PRODUCT_PILOT.md` for current phase,
active milestones, and product direction. After completing work, check the session-end
checklist in the Pilot and update any relevant product docs in `docs/product/`.
```

## For Custom System Prompts

```
You must read docs/product/PRODUCT_PILOT.md at the start of every session. It contains
